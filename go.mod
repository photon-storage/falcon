module github.com/photon-storage/falcon
...
require (
	...
	github.com/photon-storage/go-gw3 v0.0.0-20230804190644-0552af4aa345
	github.com/photon-storage/go-rc-pinner v0.0.0-20230818084530-9df74812d386
